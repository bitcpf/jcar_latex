BASE = whitemesh
SRC = whitemesh.tex architecture.tex results.tex wmalgorithms.tex experiment_design.tex conclusion.tex abstract.tex introduction.tex related.tex model.tex whitemesh.bib linearopt.tex
